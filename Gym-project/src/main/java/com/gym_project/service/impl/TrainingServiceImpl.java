...
public class TrainingServiceImpl implements TrainingService {
    ...
    public TrainingServiceImpl(
            ...
            TraineeRepository traineeRepository, ReportServiceClient reportServiceClient, GymMetrics gymMetrics
    ) {
    ...
    public void create(TrainingCreateRequestDto dto) {
        ...
        ReportWorkloadRequest workloadRequest = ReportWorkloadRequest.builder()
                ...
                .actionType(ReportWorkloadRequest.ActionType.ADD)
                .build();

        reportServiceClient.sendWorkload(workloadRequest, MDC.get("transactionId"));
    }
    ...
    public void delete(Long trainingId) {
        ...
        ReportWorkloadRequest workloadRequest = ReportWorkloadRequest.builder()
                ...
                .actionType(ReportWorkloadRequest.ActionType.DELETE)
                .build();
